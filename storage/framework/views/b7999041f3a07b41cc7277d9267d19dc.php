...
<div class="requests-container" x-data="requestsData()" x-init="init()">
    <div class="page-header">
        <h1>依頼一覧</h1>
        <a href="<?php echo e(route('requests.create')); ?>" class="btn-primary-icon">
            新しい依頼を作成
        </a>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/maiki/Downloads/ガイドヘルパー/resources/views/requests/index.blade.php ENDPATH**/ ?>