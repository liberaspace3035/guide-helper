...
<div class="register-container" x-data="registerForm()">
    <div class="register-card">
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>" @submit.prevent="handleSubmit" aria-label="ユーザー登録フォーム">
            <?php echo csrf_field(); ?>
        ...
        <p class="login-link">
            既にアカウントをお持ちの方は
            <a href="<?php echo e(route('login')); ?>">こちらからログイン</a>
        </p>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/maiki/Downloads/ガイドヘルパー/resources/views/auth/register.blade.php ENDPATH**/ ?>