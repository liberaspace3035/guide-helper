...
<div class="admin-dashboard" x-data="adminDashboard()" x-init="init()">
    ...
    <div class="admin-tabs">
        ...
        <button
            ...
            @click="activeTab = 'monthly-limits'; if (users.length === 0) fetchUsers(); else { users.forEach(u => fetchUserCurrentLimit(u.id)); }"
        >
            限度時間管理
        </button>
        <button
    ...
    <div class="admin-tab-content">
        ...
        <template x-if="activeTab === 'announcements'">
            <div x-data="announcementManagement()" x-init="init()">
                <?php echo $__env->make('admin.announcement-management', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </template>
...
<link rel="stylesheet" href="<?php echo e(asset('css/AnnouncementManagement.css')); ?>">
<?php $__env->stopPush(); ?>
    ...
    return {
        ...
        async fetchDashboardData() {
            try {
                ...
                const [
                    ...
                    fetchWithErrorHandling('/api/admin/requests', { headers }).catch((error) => {
                        console.error('❌ API失敗: /api/admin/requests', error);
                        return { requests: [] };
                    }),
                    fetchWithErrorHandling('/api/admin/acceptances', { headers }).catch((error) => {
                        console.error('❌ API失敗: /api/admin/acceptances', error);
                        return { acceptances: [] };
                    }),
                    fetchWithErrorHandling('/api/admin/reports', { headers }).catch((error) => {
                        console.error('❌ API失敗: /api/admin/reports', error);
                        return { reports: [] };
                    }),
                    fetchWithErrorHandling('/api/admin/reports/user-approved', { headers }).catch((error) => {
                        console.error('❌ API失敗: /api/admin/reports/user-approved', error);
                        return { reports: [] };
                    }),
                    fetchWithErrorHandling('/api/admin/settings/auto-matching', { headers }).catch((error) => {
                        console.error('❌ API失敗: /api/admin/settings/auto-matching', error);
                        return { auto_matching: false };
                    }),
                    fetchWithErrorHandling('/api/admin/stats', { headers }).catch((error) => {
                        console.error('❌ API失敗: /api/admin/stats', error);
                        return {};
                    }),
                    fetchWithErrorHandling('/api/users/stats', { headers }).catch((error) => {
        ...
        async fetchUsers() {
            try {
                ...
                this.users.forEach(u => {
                    ...
                    // 限度時間タブ用に、現在月の限度時間/使用時間/残時間も取得
                    this.fetchUserCurrentLimit(u.id);
                });
            } catch (error) {
        ...
        async approveReport(reportId) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    const errorData = await response.json().catch(() => ({ error: 'エラーが発生しました' }));
                    console.error('報告書管理者承認エラー:', response.status, errorData);
                    alert('報告書の管理者承認に失敗しました: ' + (errorData.error || '不明なエラー'));
                }
            } catch (error) {
        ...
        async approveUser(userId) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    const errorData = await response.json().catch(() => ({ error: 'エラーが発生しました' }));
                    console.error('ユーザー承認エラー:', response.status, errorData);
                    alert('ユーザー承認に失敗しました: ' + (errorData.error || '不明なエラー'));
                }
            } catch (error) {
        ...
        async approveGuide(guideId) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    const errorData = await response.json().catch(() => ({ error: 'エラーが発生しました' }));
                    console.error('ガイド承認エラー:', response.status, errorData);
                    alert('ガイド承認に失敗しました: ' + (errorData.error || '不明なエラー'));
                }
            } catch (error) {
        ...
        async rejectGuide(guideId) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    const errorData = await response.json().catch(() => ({ error: 'エラーが発生しました' }));
                    console.error('ガイド拒否エラー:', response.status, errorData);
                    alert('ガイド拒否に失敗しました: ' + (errorData.error || '不明なエラー'));
                }
            } catch (error) {
        ...
        async setUserMonthlyLimit(userId) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    alert(error.error || '限度時間の設定に失敗しました');
                }
            } catch (error) {
        ...
        async fetchUserCurrentLimit(userId) {
            try {
                ...
                console.error('現在の限度時間取得エラー:', error);
            }
        },
        ...
        async handleSubmit() {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    const error = await response.json();
                    alert(error.error || 'お知らせの保存に失敗しました');
                }
            } catch (error) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/maiki/Downloads/ガイドヘルパー/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>