    ...
    <div class="layout" x-data="{ sidebarVisible: window.innerWidth > 768, isMobile: window.innerWidth <= 768 }" 
        ...
        <aside class="sidebar" :class="{ 'sidebar-hidden': !sidebarVisible }" role="navigation" aria-label="メインナビゲーション">
            <div class="sidebar-header">
                <a href="<?php echo e(route('dashboard')); ?>" class="sidebar-logo" aria-label="ダッシュボードへ戻る">
                    <div class="logo-icon-wrapper">
                        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="ガイドマッチ" class="logo-icon" />
                    </div>
            ...
            <nav class="nav">
                <ul class="nav-list">
                    <li>
                        <a href="<?php echo e(route('dashboard')); ?>" :aria-current="window.location.pathname === '/dashboard' ? 'page' : undefined">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <?php if(auth()->user()->isUser()): ?>
                            <li>
                                <a href="<?php echo e(route('requests.create')); ?>" :aria-current="window.location.pathname === '/requests/new' ? 'page' : undefined">
                                    <svg class="nav-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <li>
                                <a href="<?php echo e(route('requests.index')); ?>" :aria-current="window.location.pathname === '/requests' ? 'page' : undefined">
                                    <svg class="nav-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <?php if(auth()->user()->isGuide()): ?>
                            <li>
                                <a href="<?php echo e(route('guide.requests.index')); ?>" :aria-current="window.location.pathname === '/guide/requests' ? 'page' : undefined">
                                    <svg class="nav-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <line x1="8" y1="6" x2="21" y2="6"></line>
                                        <line x1="8" y1="12" x2="21" y2="12"></line>
                                        <line x1="8" y1="18" x2="21" y2="18"></line>
                        ...
                        <?php if(auth()->user()->isAdmin()): ?>
                            <li>
                                <a href="<?php echo e(route('admin.dashboard')); ?>" :aria-current="window.location.pathname === '/admin' ? 'page' : undefined">
                                    <svg class="nav-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <?php endif; ?>
                        <li>
                            <a href="<?php echo e(route('profile')); ?>" :aria-current="window.location.pathname === '/profile' ? 'page' : undefined">
                                <svg class="nav-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="main-wrapper">
                ...
                <div class="header-content">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <div class="user-menu" x-data="headerMenu()" x-init="init()">
                            ...
                            <a href="<?php echo e(route('profile')); ?>" class="user-info" aria-label="プロフィール">
                                <div class="user-avatar" aria-hidden="true">
                                    <?php echo e(strtoupper(substr(auth()->user()->name ?? 'U', 0, 1))); ?>

                                </div>
                                <span class="user-name" aria-label="ログインユーザー: <?php echo e(auth()->user()->name); ?>">
            ...
            <footer class="footer" role="contentinfo">
                <p>&copy; <?php echo e(date('Y')); ?> One Step</p>
            </footer>
        </div>
    </div>
...
<?php /**PATH /Users/maiki/Downloads/ガイドヘルパー/resources/views/layouts/app.blade.php ENDPATH**/ ?>