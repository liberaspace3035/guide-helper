...
<div class="request-form-container" x-data="requestForm()" x-init="init()">
    <h1>依頼作成</h1>
    <form method="POST" action="<?php echo e(route('requests.store')); ?>" @submit.prevent="handleSubmit($event)" x-ref="requestForm" class="request-form" aria-label="依頼作成フォーム">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-actions full-width">
            ...
            <a href="<?php echo e(route('requests.index')); ?>" class="btn-secondary" aria-label="キャンセル">
                キャンセル
            </a>
        </div>
    </form>
...
<link rel="stylesheet" href="<?php echo e(asset('css/RequestForm.css')); ?>">
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/maiki/Downloads/ガイドヘルパー/resources/views/requests/create.blade.php ENDPATH**/ ?>