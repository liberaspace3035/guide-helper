...
<div class="home-container">
    ...
    <section class="hero-section">
        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" class="hero-logo" />
        <?php if(auth()->guard()->guest()): ?>
            <a href="<?php echo e(route('login')); ?>" class="hero-login-btn">
                ログイン
            </a>
        <?php endif; ?>
        <div class="hero-content">
            ...
            <div class="hero-actions">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="btn-primary btn-large">
                        ダッシュボードへ
                    </a>
                <?php else: ?>
                    <button onclick="window.location.href='<?php echo e(route('register')); ?>'" class="btn-primary btn-large">
                        今すぐ始める
                    </button>
                <?php endif; ?>
            </div>
        ...
        <section class="cta-section">
            <div class="container">
                ...
                <div class="cta-actions">
                    <a href="<?php echo e(route('register')); ?>" class="btn-primary btn-large">
                        無料で登録
                    </a>
                    <a href="<?php echo e(route('login')); ?>" class="btn-secondary btn-large">
                        ログイン
                    </a>
                </div>
                <p class="cta-note">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/maiki/Downloads/ガイドヘルパー/resources/views/home.blade.php ENDPATH**/ ?>