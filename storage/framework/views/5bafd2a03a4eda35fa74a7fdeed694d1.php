...
<div class="chat-container" x-data="chatData()" x-init="init()">
    <div class="chat-header">
        <div class="chat-header-info">
            <a :href="`<?php echo e(url('/matchings')); ?>/${matchingId}`" class="chat-back-link" aria-label="戻る">
            ...
            <template x-for="(message, index) in messages" :key="message.id || index">
                <div>
                    ...
                    >
                        ...
                        <template x-if="isOwnMessage(message) && showAvatar(index)">
                            <div class="message-avatar message-avatar-own" x-text="'<?php echo e(auth()->user()->name); ?>'.charAt(0).toUpperCase()"></div>
                        </template>
                    </div>
                </div>
            </template>
    ...
    return {
        ...
        async sendMessage() {
            ...
            const tempMessage = {
                ...
                sender_name: '<?php echo e(auth()->user()->name); ?>',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/maiki/Downloads/ガイドヘルパー/resources/views/chat/show.blade.php ENDPATH**/ ?>