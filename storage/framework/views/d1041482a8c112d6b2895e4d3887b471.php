...
<link rel="stylesheet" href="<?php echo e(asset('css/ReportForm.css')); ?>">
<?php $__env->stopPush(); ?>
...
function reportForm() {
    return {
        matchingId: <?php echo e($matchingId); ?>,
        existingReport: <?php echo json_encode($existingReport, 15, 512) ?>,
        formData: {
            service_content: '',
            report_content: '',
            actual_date: '',
        ...
        init() {
            if (this.existingReport) {
                ...
                // マッチング情報から初期値を設定
                const matching = <?php echo json_encode($matching, 15, 512) ?>;
        ...
        async handleSave() {
            ...
            try {
                ...
                const response = await fetch('<?php echo e(route("guide.reports.store")); ?>', {
                    method: 'POST',
                    body: formData,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/maiki/Downloads/ガイドヘルパー/resources/views/guide/reports/create.blade.php ENDPATH**/ ?>